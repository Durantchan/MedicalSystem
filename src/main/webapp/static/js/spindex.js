...
var splogin = {
	...
	initMenuEvent: function(menuData){
		...
		$("#menu_ul a[name=topMenu]").click(function(e, jump_menu_id){
			...
			//	return;
				...
				userMenuCenter.initMenu(subMenus, jump_menu_id);
			});
			}
		});
	},
	...
	login: function(){
		...
		Invoker.async("SPUserController", "getCustName", params, function(result){
			...
			if(res_code == "00000"){
				//$(".top-client-name").html(result.result.cust.cust_name);//放cust_name
